...
A P2 (server-side) Confluence plugin that adds a **Mermaid macro** 
---

This plugin enables authors to write diagram source text directly in Confluence pages and have it rendered as a crisp SVG — exactly like PlantUML, but powered by [mermaid.js](https://mermaid.js.org).
